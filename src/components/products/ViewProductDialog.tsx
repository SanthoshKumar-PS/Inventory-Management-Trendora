...
const ViewProductDialog = ({product, open, onClose}:ViewProductProps) => {
    if(!product){
        return null;
    }
  return (
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-start items-center gap-4 ">
                    ...
                    <div className="flex-1">
                        <h1 className="text-sm  md:text-lg lg:text-2xl font-bold mb-1">{product.name}</h1>
                        <p className="text-sm md:text-lg text-muted-foreground max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">{formatProductId(product.id,3)}</p>
                    </div>
